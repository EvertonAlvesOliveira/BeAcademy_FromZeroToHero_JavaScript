...
// const domCasmurro = new Book('Bom Casmurro', 1899, 'Machado de Assis')
...
const candidate1 = new Masc('Marcelo', 'Vasques', 12345678911, true)
const candidate2 = new Candidates('Maria', 'Fulana', 98765432199)
